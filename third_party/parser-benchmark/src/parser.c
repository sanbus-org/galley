...
static const yytype_uint8 yyprhs[] =
{
      ...
      19,    22,    26,    28,    32,    36,    39,    43,    45
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      15,     0,    -1,    16,    -1,    17,    -1,    20,    -1,     3,
      -1,     4,    -1,     5,    -1,     6,    -1,     7,    -1,     8,
       9,    -1,     8,    18,     9,    -1,    19,    -1,    18,    10,
      19,    -1,     3,    11,    16,    -1,    12,    13,    -1,    12,
      21,    13,    -1,    16,    -1,    21,    10,    16,    -1
};

/* YYRLINE[YYN] -- source line where rule number YYN was defined.  */
static const yytype_uint16 yyrline[] =
{
       0,   287,   287,   291,   292,   293,   294,   295,   296,   297,
     301,   302,   306,   311,   323,   333,   334,   338,   343
};
#endif
...
{
  "$end", "error", "$undefined", "STRING", "NUMBER", "TRUE", "FALSE",
  "NULL_TOK", "'{'", "'}'", "','", "':'", "'['", "']'", "$accept", "json",
...
{
       0,     5,     6,     7,     8,     9,     0,     0,     0,     2,
       3,     4,     0,    10,     0,    12,    15,    17,     0,     1,
       0,    11,     0,     0,    16,    14,    13,    18
};
...
{
      14,    -8,    -8,    -8,    -8,    -8,     5,    -2,     7,    -8,
      -8,    -8,     4,    -8,    15,    -8,    -8,    -8,    -1,    -8,
      14,    -8,    20,    14,    -8,    -8,    -8,    -8
};
...
{
      17,     1,     2,     3,     4,     5,     6,    19,    12,    23,
       7,    16,    24,    25,    13,    20,    27,     1,     2,     3,
       4,     5,     6,    12,    21,    22,     7,     0,    26
};

static const yytype_int8 yycheck[] =
{
       7,     3,     4,     5,     6,     7,     8,     0,     3,    10,
      12,    13,    13,    20,     9,    11,    23,     3,     4,     5,
       6,     7,     8,     3,     9,    10,    12,    -1,    22
};
...
static const yytype_uint8 yystos[] =
{
      ...
      17,    20,     3,     9,    18,    19,    13,    16,    21,     0,
      11,     9,    10,    10,    13,    16,    19,    16
};
  ...
  switch (yyn)
    {
        case 2:
#line 287 "src/json.y"
    { if (bison_build_ast || bison_build_advanced_ast || bison_build_payload_ast) { bison_root_node = (yyvsp[(1) - (1)].node); } ;}
    break;
...
#line 292 "src/json.y"
  ...
  case 5:
#line 293 "src/json.y"
    { if (bison_build_ast || bison_build_advanced_ast || bison_build_payload_ast) { (yyval.node) = make_any_node(bison_current_arena, NODE_STRING, (yyvsp[(1) - (1)].token).text, (yyvsp[(1) - (1)].token).length); } ;}
    break;

  case 6:
#line 294 "src/json.y"
    { if (bison_build_ast || bison_build_advanced_ast || bison_build_payload_ast) { (yyval.node) = make_any_node(bison_current_arena, NODE_NUMBER, (yyvsp[(1) - (1)].token).text, (yyvsp[(1) - (1)].token).length); } ;}
    break;

  case 7:
#line 295 "src/json.y"
    { if (bison_build_ast || bison_build_advanced_ast || bison_build_payload_ast) { (yyval.node) = make_any_node(bison_current_arena, NODE_TRUE, (yyvsp[(1) - (1)].token).text, (yyvsp[(1) - (1)].token).length); } ;}
    break;

  case 8:
#line 296 "src/json.y"
    { if (bison_build_ast || bison_build_advanced_ast || bison_build_payload_ast) { (yyval.node) = make_any_node(bison_current_arena, NODE_FALSE, (yyvsp[(1) - (1)].token).text, (yyvsp[(1) - (1)].token).length); } ;}
    break;

  case 9:
#line 297 "src/json.y"
    { if (bison_build_ast || bison_build_advanced_ast || bison_build_payload_ast) { (yyval.node) = make_any_node(bison_current_arena, NODE_NULL, (yyvsp[(1) - (1)].token).text, (yyvsp[(1) - (1)].token).length); } ;}
    break;

  case 10:
#line 301 "src/json.y"
    { if (bison_build_ast || bison_build_advanced_ast || bison_build_payload_ast) { (yyval.node) = make_any_node(bison_current_arena, NODE_OBJECT, "{}", 2); } ;}
    break;

  case 11:
#line 302 "src/json.y"
    { if (bison_build_ast || bison_build_advanced_ast || bison_build_payload_ast) { (yyval.node) = (yyvsp[(2) - (3)].node); } ;}
    break;

  case 12:
#line 306 "src/json.y"
    { if (bison_build_ast || bison_build_advanced_ast || bison_build_payload_ast) { 
        void *obj = make_any_node(bison_current_arena, NODE_OBJECT, node_text_start((yyvsp[(1) - (1)].node)), node_text_length((yyvsp[(1) - (1)].node))); 
        append_any_child(obj, (yyvsp[(1) - (1)].node)); 
        (yyval.node) = obj; 
    } ;}
    break;
...
#line 311 "src/json.y"
    { if (bison_build_ast || bison_build_advanced_ast || bison_build_payload_ast) { 
        append_any_child((yyvsp[(1) - (3)].node), (yyvsp[(3) - (3)].node)); 
        if (bison_build_advanced_ast || bison_build_payload_ast) {
            ((AdvancedASTNode *)(yyvsp[(1) - (3)].node))->text_length = (node_text_start((yyvsp[(3) - (3)].node)) + node_text_length((yyvsp[(3) - (3)].node))) - node_text_start((yyvsp[(1) - (3)].node));
        } else {
            ((ASTNode *)(yyvsp[(1) - (3)].node))->text_length = (node_text_start((yyvsp[(3) - (3)].node)) + node_text_length((yyvsp[(3) - (3)].node))) - node_text_start((yyvsp[(1) - (3)].node));
        }
...
#line 323 "src/json.y"
    { if (bison_build_ast || bison_build_advanced_ast || bison_build_payload_ast) { 
        const char *start = (yyvsp[(1) - (3)].token).text;
        size_t len = (node_text_start((yyvsp[(3) - (3)].node)) + node_text_length((yyvsp[(3) - (3)].node))) - start;
        void *m = make_any_node(bison_current_arena, NODE_MEMBER, start, len); 
        append_any_child(m, (yyvsp[(3) - (3)].node)); 
        (yyval.node) = m; 
    } ;}
    break;
  ...
  case 15:
#line 333 "src/json.y"
    { if (bison_build_ast || bison_build_advanced_ast || bison_build_payload_ast) { (yyval.node) = make_any_node(bison_current_arena, NODE_ARRAY, "[]", 2); } ;}
    break;
...
#line 338 "src/json.y"
    { if (bison_build_ast || bison_build_advanced_ast || bison_build_payload_ast) { 
        void *arr = make_any_node(bison_current_arena, NODE_ARRAY, node_text_start((yyvsp[(1) - (1)].node)), node_text_length((yyvsp[(1) - (1)].node))); 
        append_any_child(arr, (yyvsp[(1) - (1)].node)); 
        (yyval.node) = arr; 
    } ;}
    break;
