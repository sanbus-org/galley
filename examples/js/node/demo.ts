...
function printTree(node: import("@sanbus/galley-node").Node, depth: number): void {
  ...
  try {
    ...
    if (args.length > 0) {
      try {
        ...
        const galleyErr = err as import("@sanbus/galley-node").GalleyError;
