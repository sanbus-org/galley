 ...
 * native-first resolution, wasm pinning, and the synchronous `Session`
 * path (`ensureSync` via `createRequire`, which is the Bun-risky leg).
 *
 * Run:
 ...
 * with the bun and wasm builders into a temp workdir.
 */
...
const { findLibrary: findNativeLibrary } = await import("@sanbus/galley-bun");
