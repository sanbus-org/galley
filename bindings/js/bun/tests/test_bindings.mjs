 ...
 *   GALLEY_LIBRARY_PATH=/tmp/libgalley-js-bun.dylib bun ...
 */
...
const exampleLib = (() => {
  if (process.platform === "darwin") return "libgalley-js-bun.dylib";
  if (process.platform === "win32") return "galley-js-bun.dll";
  return "libgalley-js-bun.so";
})();
const defaultLibPath = path.resolve(__dirname, "../../../../examples/js/bun", exampleLib);
