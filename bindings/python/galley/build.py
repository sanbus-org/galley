...
def main() -> None:
    ...
    if init_path.is_file():
        ...
        if (
            GENERATED_MARKER not in init_text
            and LEGACY_GENERATED_MARKER not in init_text
        ):
            fatal(
                f"{init_path} exists and was not generated by galley; "
                "move it aside so the language directory can be a package"
            )
    ...
    # the language package (compiled extensions expose no source).
