...
def parse_procedures_zig_hooks(procedures_zig_path: Path) -> list[str]:
    try:
...
def emit_python_procedure_shim(template_path: Path, output_path: Path) -> None:
    try:
