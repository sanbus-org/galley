...
pub const Offsets = struct {
    ...
    pub fn append(self: *Self, offset: i8) !void {
    ...
    pub fn pop(self: *Self, len: usize) !void {
        if (builtin.mode == .Debug and self.len < len) {
            std.log.err("Offsets is empty!\n", .{});
            return error.OffsetsOverflow;
        }
        self.len -= len;
    ...
    pub fn sum(self: *const Self, start: usize, end: usize) u16 {
        var sum_: i16 = 0;
